...
<body>
    <div class="div1"><h2>Demo 3 - Content Slider</h2>
    ...
    <div class="div2">         
        <ul>
            <li>This is the plain JavaScript version of the <a href="http://www.menucool.com/jquery-slider">jQuery Slider</a> (Non-jQuery)</li>
            <li>This demo demonstrates that Menucool jQuery Slider can be used as a Content Slider as the Menucool jQuery Slider allows any HTML content</li>            
            <li>Using this slider requires a license. <b>Otherwise it will only work locally but not on the Internet</b>;</li>
